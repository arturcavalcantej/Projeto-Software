...
def cadhorista():
    print("Empregado(a) Horista:")
    name = input("Digite o nome: ")
    address = input("Digite o endereço: ")
    salary = float(input("Digite o salario: "))
    emp = Horista(name, address, salary)

    return emp


def cadassalariado():
    print("Empregado assalariado:")
    name = input("Digite o nome: ")
    address = input("Digite o endereço: ")
    salary = float(input("Digite o salario: "))
    emp = Assalariado(name, address, salary)
...
def cadcomissionado():
    print("Empregado comissionado:")
    name = input("Digite o nome: ")
    address = input("Digite o endereço: ")
    salary = float(input("Digite o salario: "))
    bonus = float(input("Digite o bônus percentual (%): "))
    emp = Comissionado(name, address, salary, bonus)
...
def novodados(dictionary, key):
    ...
    if (dictionary[key]['worker'].kind == 'Horista'):
        dictionary[key]['worker'].EditHorista(newName, newAddress, newSalary)
        print("Empregado editado")

    elif (dictionary[key]['worker'].kind == 'Assalariado'):
        dictionary[key]['worker'].EditAssalariado(newName, newAddress, newSalary)
        print("Empregado editado")

    elif (dictionary[key]['worker'].kind == 'Comissionado'):
        newBonus = float(input("Digite o novo bonus: "))
        dictionary[key]['worker'].EditComissionado(newAddress, newAddress, newSalary, newBonus)
        print("Empregado editado")
...
def pagar(dictionary, unionDic, schedule, day):
    if len(dictionary) == 0:
        print("Não há Empregados para serem pagos")
    elif (day.weekday() > 4):
        print("É fim de semana, não há pagamentos")
    else:
